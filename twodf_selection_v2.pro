PRO twodf_selection_v2, file_raw , ra_str , dec_str , PSTAR = pstar , CLASS = class , CENTRE = centre 
...
;### NEW WISE COLOUR CUT
wise_two = WHERE( 					$	
		(data.g3 GT 1 AND data.w1 GT 5. AND data.w2 ne 0.)		AND $
		(w1w2 GE 0.4 				AND $
		data.g3 LT 19.5				AND $
		data.g3 GE 16.0				AND $
		w1w2 LT 10.0)				OR $
...
strreplace, file_target,'.mer', '_targets_v2_3arcsec.fits'
...
STRREPLACE, file_fld,'.mer', '_v2_3arcsec.fld'
